...
SOURCES = \
	__init__.py \
	BDOT10k_GML_SHP_loader.py BDOT10k_GML_SHP_loader_dialog.py

PLUGINNAME = BDOT10k_GML_SHP_loader
...
QGISDIR=C:\Users\marcinlebiecki\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins

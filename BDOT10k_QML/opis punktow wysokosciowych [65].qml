...
<qgis maxScale="0" symbologyReferenceScale="-1" simplifyDrawingTol="1" simplifyMaxScale="1" styleCategories="Symbology|Symbology3D|Labeling|Fields|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend|Elevation|Notes" hasScaleBasedVisibilityFlag="1" minScale="10001" simplifyAlgorithm="0" simplifyLocal="1" labelsEnabled="1" simplifyDrawingHints="0" version="3.22.15-Białowieża">
  ...
  <renderer-v2 referencescale="-1" forceraster="0" symbollevels="1" enableorderby="0" type="singleSymbol">
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textOpacity="1" fontKerning="1" legendString="Aa" allowHtml="0" textColor="50,50,50,255" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSize="25.5" isExpression="0" fontFamily="Arial Narrow" fontSizeUnit="MapUnit" blendMode="0" fieldName="wysokosc" useSubstitutions="0" textOrientation="horizontal" capitalization="0" fontWeight="75" multilineHeight="1" fontUnderline="0" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" fontLetterSpacing="0" namedStyle="Bold" fontItalic="0">
        <families/>
        <text-buffer bufferSizeUnits="MapUnit" bufferDraw="1" bufferSize="2" bufferOpacity="1" bufferColor="250,250,250,255" bufferBlendMode="0" bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128"/>
        <text-mask maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskJoinStyle="128" maskedSymbolLayers="" maskEnabled="0" maskOpacity="1" maskType="0" maskSize="5" maskSizeUnits="MapUnit"/>
      ...
      <text-format addDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" decimals="1" leftDirectionSymbol="&lt;" wrapChar="" formatNumbers="1" placeDirectionSymbol="0" reverseDirectionSymbol="0" autoWrapLength="0" rightDirectionSymbol=">" plussign="0" multilineAlign="3"/>
      <placement geometryGenerator="" dist="0.20000000000000001" polygonPlacementFlags="2" overrunDistance="0" lineAnchorClipping="0" offsetUnits="MM" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="6" yOffset="0" lineAnchorPercent="0.5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" placementFlags="10" maxCurvedCharAngleOut="-25" fitInPolygonOnly="0" geometryGeneratorEnabled="0" xOffset="0" centroidInside="0" repeatDistance="0" offsetType="1" preserveRotation="1" geometryGeneratorType="PointGeometry" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" overrunDistanceUnit="MM" placement="6" distUnits="MapUnit" centroidWhole="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="PointGeometry" quadOffset="4"/>
      <rendering minFeatureSize="0" scaleMax="0" scaleMin="0" displayAll="0" fontMinPixelSize="3" zIndex="0" scaleVisibility="0" labelPerPart="0" unplacedVisibility="0" upsidedownLabels="0" maxNumLabels="2000" obstacleFactor="2" obstacle="0" limitNumLabels="0" fontMaxPixelSize="10000" mergeLines="0" obstacleType="1" drawLabels="1" fontLimitPixelSize="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias index="7" name="" field="kodKarto10k"/>
    <alias index="8" name="" field="rodzaj"/>
    <alias index="9" name="" field="wysokosc"/>
    <alias index="10" name="" field="wysokosc_uom"/>
    <alias index="11" name="" field="informacjaDodatkowa"/>
    <alias index="12" name="" field="KOD10K"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" unique_strength="0" field="wysokosc" notnull_strength="0"/>
    <constraint constraints="0" exp_strength="0" unique_strength="0" field="wysokosc_uom" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="wysokosc_uom" desc=""/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="wysokosc" width="-1" hidden="0" type="field"/>
      <column name="wysokosc_uom" width="-1" hidden="0" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="wysokosc_uom" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="wysokosc_uom"/>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="wysokosc"/>
    <field reuseLastValue="0" name="wysokosc_uom"/>

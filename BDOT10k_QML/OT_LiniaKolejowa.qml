...
<qgis maxScale="0" minScale="1e+08" hasScaleBasedVisibilityFlag="0" version="3.12.1-București" styleCategories="AllStyleCategories" readOnly="0">
  ...
  <aliases>
    ...
    <alias field="nrLinii" index="1" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default field="gml_id" expression="" applyOnUpdate="0"/>
    <default field="nrLinii" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    <constraint field="gml_id" constraints="1" notnull_strength="1" exp_strength="0" unique_strength="0"/>
    <constraint field="nrLinii" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="gml_id" exp="" desc=""/>
    <constraint field="nrLinii" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" name="nrLinii" hidden="0" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="nrLinii" editable="1"/>
  </editable>
  <labelOnTop>
    <field name="gml_id" labelOnTop="0"/>
    <field name="nrLinii" labelOnTop="0"/>
  </labelOnTop>
  <widgets/>

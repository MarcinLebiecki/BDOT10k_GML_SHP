...
<qgis maxScale="1000" simplifyAlgorithm="0" labelsEnabled="0" readOnly="1" hasScaleBasedVisibilityFlag="1" simplifyMaxScale="1" simplifyLocal="1" minScale="10001" version="3.12.1-București" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyDrawingHints="0">
  <flags>
  ...
  <renderer-v2 attr="KOD10K" enableorderby="0" forceraster="0" type="categorizedSymbol" symbollevels="0">
    <categories>
      <category symbol="0" value="0010_612" label="źródło" render="true"/>
      <category symbol="1" value="0010_728" label="mały las" render="true"/>
      <category symbol="2" value="0010_731" label="pojedyncze drzewo lub grupa drzew" render="true"/>
      <category symbol="3" value="0010_732" label="drzewo - pomnik przyrody" render="true"/>
      <category symbol="4" value="0010_734" label="kępa krzewów" render="true"/>
      <category symbol="5" value="0010_735" label="kępa kosodrzewiny" render="true"/>
      <category symbol="6" value="0010_816" label="głaz lub grupa głazów" render="true"/>
      <category symbol="7" value="0010_817" label="wejście do jaskini" render="true"/>
      <category symbol="8" value="0010_815" label="odosobniona skała" render="true"/>
    </categories>
    <symbols>
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="0" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          <prop k="angle" v="0"/>
          <prop k="color" v="114,217,41,255"/>
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_612.svg"/>
          <prop k="offset" v="0,0"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="1" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          <prop k="angle" v="0"/>
          <prop k="color" v="80,37,200,255"/>
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_728.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="2" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          <prop k="angle" v="0"/>
          <prop k="color" v="228,98,237,255"/>
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_731.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="3" alpha="0.827451">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          <prop k="angle" v="0"/>
          <prop k="color" v="227,26,28,255"/>
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_732.svg"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="5" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          <prop k="angle" v="0"/>
          <prop k="color" v="215,117,81,255"/>
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_735.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="6" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          <prop k="angle" v="0"/>
          <prop k="color" v="70,214,106,255"/>
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_816.svg"/>
          <prop k="offset" v="0,-5"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="7" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          <prop k="angle" v="0"/>
          <prop k="color" v="39,106,205,255"/>
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_817.svg"/>
          <prop k="offset" v="0,-5"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="8" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_815.svg"/>
          <prop k="offset" v="0,-10"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
  ...
  <aliases>
    ...
    <alias field="pomnikPrzyrody" index="25" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="pomnikPrzyrody" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="pomnikPrzyrody" constraints="0" notnull_strength="0" unique_strength="0"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="&quot;KOD10K&quot;" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" width="-1" name="pomnikPrzyrody" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="pomnikPrzyrody"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="pomnikPrzyrody"/>

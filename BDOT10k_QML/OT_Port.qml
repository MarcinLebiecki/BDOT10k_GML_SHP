...
<qgis maxScale="0" minScale="1e+08" hasScaleBasedVisibilityFlag="0" version="3.12.1-București" styleCategories="AllStyleCategories" readOnly="0">
  ...
  <aliases>
    ...
    <alias field="lokalizacjaPortu" index="1" name=""/>
  ...
  <defaults>
    ...
    <default field="lokalizacjaPortu" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="lokalizacjaPortu" constraints="0" notnull_strength="0" exp_strength="0" unique_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="lokalizacjaPortu" exp="" desc=""/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" name="lokalizacjaPortu" hidden="0" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="lokalizacjaPortu" editable="1"/>
    <field name="rodzaj" editable="1"/>
  </editable>
  <labelOnTop>
    <field name="gml_id" labelOnTop="0"/>
    <field name="lokalizacjaPortu" labelOnTop="0"/>

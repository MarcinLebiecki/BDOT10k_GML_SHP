...
<qgis simplifyAlgorithm="0" styleCategories="AllStyleCategories" maxScale="1000" minScale="10001" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" readOnly="1" version="3.12.1-București" labelsEnabled="0" simplifyDrawingTol="1" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 type="categorizedSymbol" symbollevels="0" attr=" KOD10K" enableorderby="0" forceraster="0">
    <categories>
      <category value="0010_227" symbol="0" render="true" label="kolej liniowa"/>
      <category value="0010_228" symbol="1" render="true" label="wyciąg narciarski"/>
      <category value="0010_433_1" symbol="2" render="true" label="suwnica w skali"/>
      <category value="0010_433_2" symbol="3" render="true" label="suwnica (symbol)"/>
      <category value="0010_434" symbol="4" render="true" label="taśmociąg"/>
    </categories>
    <symbols>
        ...
        <layer class="MarkerLine" enabled="1" locked="0" pass="0">
          ...
          <symbol type="marker" alpha="1" name="@1@2" force_rhr="0" clip_to_extent="1">
            <layer class="SvgMarker" enabled="1" locked="0" pass="0">
              ...
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v=""/>
              <prop k="offset" v="4.59999999999999964,0"/>
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MapUnit"/>
      ...
      <symbol type="line" alpha="0.668" name="2" force_rhr="0" clip_to_extent="1">
        <layer class="SimpleLine" enabled="1" locked="0" pass="0">
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="20;8"/>
          <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="customdash_unit" v="MapUnit"/>
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
    ...
    <source-symbol>
      <symbol type="line" alpha="1" name="0" force_rhr="0" clip_to_extent="1">
        <layer class="SimpleLine" enabled="1" locked="0" pass="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="152,44,111,255"/>
          <prop k="line_style" v="solid"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Pie">
    <DiagramCategory spacingUnitScale="3x:0,0,0,0,0,0" scaleBasedVisibility="0" minScaleDenominator="1000" barWidth="5" penWidth="0" backgroundColor="#ffffff" spacingUnit="MM" penColor="#000000" enabled="0" lineSizeType="MM" direction="1" maxScaleDenominator="1e+08" rotationOffset="270" opacity="1" lineSizeScale="3x:0,0,0,0,0,0" backgroundAlpha="255" height="15" sizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" minimumSize="0" spacing="0" penAlpha="255" width="15" sizeType="MM" diagramOrientation="Up" scaleDependency="Area" showAxis="0">
  ...
  <aliases>
    ...
    <alias field="dlugosc" index="25" name=""/>
    <alias field="dlugosc_uom" index="26" name=""/>
    <alias field="rodzaj" index="27" name=""/>
    <alias field="szerokosc" index="28" name=""/>
    <alias field="szerokosc_uom" index="29" name=""/>
    <alias field="KOD10K" index="30" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="dlugosc"/>
    <default applyOnUpdate="0" expression="" field="dlugosc_uom"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" notnull_strength="0" field="x_doklGeom" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" notnull_strength="0" field="x_doklGeom_uom" unique_strength="0" exp_strength="0"/>
    ...
    <constraint constraints="0" notnull_strength="0" field="dlugosc" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" notnull_strength="0" field="dlugosc_uom" unique_strength="0" exp_strength="0"/>
    <constraint constraints="0" notnull_strength="0" field="rodzaj" unique_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="dlugosc" desc="" exp=""/>
    <constraint field="dlugosc_uom" desc="" exp=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;KOD10K&quot;" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="dlugosc" hidden="0"/>
      <column type="field" width="-1" name="dlugosc_uom" hidden="0"/>

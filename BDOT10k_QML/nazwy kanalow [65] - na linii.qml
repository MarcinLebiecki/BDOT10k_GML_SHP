...
<qgis simplifyAlgorithm="0" version="3.22.11-Białowieża" simplifyLocal="1" styleCategories="Symbology|Labeling|Fields|Rendering" hasScaleBasedVisibilityFlag="1" minScale="10001" simplifyDrawingTol="2" labelsEnabled="1" symbologyReferenceScale="-1" maxScale="1000" simplifyDrawingHints="3" simplifyMaxScale="1">
  <renderer-v2 forceraster="0" enableorderby="0" referencescale="-1" symbollevels="0" type="nullSymbol"/>
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textColor="83,174,221,255" isExpression="1" fontKerning="1" namedStyle="Regular" fontSizeUnit="MapUnit" previewBkgrdColor="255,255,255,255" fontItalic="0" fontSize="22" textOpacity="1" fontWeight="50" textOrientation="horizontal" fontStrikeout="0" legendString="Aa" fontFamily="Cambria" fontLetterSpacing="0" blendMode="0" fontWordSpacing="0" multilineHeight="1" fieldName="if (&quot;KOD10K&quot; = '0010_606', if ( &quot;STATUSEKS&quot; = 'żeglowny', upper( &quot;NAZWA&quot; ),   &quot;NAZWA&quot;),IF (&quot;szerokosc&quot; &lt; 10,NAZWA,''))&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;" useSubstitutions="0" capitalization="0" allowHtml="0">
        <families/>
        <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferNoFill="1" bufferDraw="0" bufferSizeUnits="MM" bufferOpacity="1" bufferJoinStyle="128" bufferColor="255,255,255,255" bufferBlendMode="0"/>
        <text-mask maskType="0" maskSizeUnits="MM" maskOpacity="1" maskJoinStyle="128" maskEnabled="0" maskSize="1.5" maskedSymbolLayers="" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
      ...
      <placement centroidInside="0" polygonPlacementFlags="2" repeatDistanceUnits="MM" offsetType="0" geometryGeneratorType="PointGeometry" maxCurvedCharAngleIn="20" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleOut="-20" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" dist="0" rotationAngle="0" lineAnchorType="0" xOffset="0" yOffset="0" preserveRotation="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" placementFlags="9" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" offsetUnits="MM" lineAnchorClipping="0" repeatDistance="0" overrunDistanceUnit="MM" centroidWhole="0" layerType="LineGeometry" lineAnchorPercent="0.5" distUnits="MM" overrunDistance="0" placement="3" priority="5" geometryGenerator="" quadOffset="4" geometryGeneratorEnabled="0"/>
      <rendering obstacle="1" zIndex="0" scaleMax="0" maxNumLabels="2000" obstacleType="1" drawLabels="1" labelPerPart="0" fontMaxPixelSize="10000" unplacedVisibility="0" minFeatureSize="0" limitNumLabels="0" obstacleFactor="1" scaleMin="0" fontLimitPixelSize="1" upsidedownLabels="0" displayAll="0" fontMinPixelSize="3" mergeLines="0" scaleVisibility="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option name="properties"/>

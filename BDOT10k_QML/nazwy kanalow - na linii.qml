...
<qgis simplifyDrawingTol="2" simplifyLocal="1" hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyAlgorithm="0" minScale="10001" simplifyDrawingHints="3" maxScale="1000" readOnly="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" version="3.12.1-București">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontStrikeout="0" blendMode="0" useSubstitutions="0" isExpression="1" fontWeight="50" textOpacity="1" fontKerning="1" fontSize="22" fontFamily="Cambria" fontSizeUnit="MapUnit" previewBkgrdColor="255,255,255,255" fontLetterSpacing="0" textColor="83,174,221,255" fontItalic="1" multilineHeight="1" fieldName="if (&quot;KOD10K&quot; is null AND (&quot;X_RODZREPG&quot; != 'SL' or &quot;X_RODZREPG&quot; != 'sztucznyLacznik') AND   (&quot;POLOZENIE&quot; != '-1' OR &quot;POLOZENIE&quot; != 'podPowierzchnia'), if ((&quot;STATUSEKS&quot; = 'Z' OR &quot;STATUSEKS&quot; = 'zeglowny'), upper(  &quot;CIEK_NAZWA&quot;  ),  &quot;CIEK_NAZWA&quot;  ),'')&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;&#xd;&#xa;" textOrientation="horizontal" namedStyle="Italic" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontCapitals="0" fontUnderline="0" fontWordSpacing="0">
        <text-buffer bufferSizeUnits="MM" bufferNoFill="1" bufferOpacity="1" bufferJoinStyle="128" bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferColor="255,255,255,255" bufferBlendMode="0"/>
      ...
      <text-format formatNumbers="0" rightDirectionSymbol=">" placeDirectionSymbol="0" decimals="3" plussign="0" wrapChar="" reverseDirectionSymbol="0" autoWrapLength="0" multilineAlign="0" leftDirectionSymbol="&lt;" useMaxLineLengthForAutoWrap="1" addDirectionSymbol="0"/>
      <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetUnits="MM" yOffset="0" distUnits="MM" layerType="LineGeometry" geometryGeneratorEnabled="0" preserveRotation="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="3" dist="0" centroidInside="0" overrunDistanceUnit="MM" quadOffset="4" maxCurvedCharAngleOut="-20" maxCurvedCharAngleIn="20" priority="5" overrunDistance="0" distMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" offsetType="0" xOffset="0" placementFlags="9" centroidWhole="0" geometryGenerator="" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" repeatDistanceUnits="MM" rotationAngle="0" repeatDistance="0"/>
      <rendering obstacle="1" maxNumLabels="2000" mergeLines="0" displayAll="0" fontMinPixelSize="3" scaleVisibility="0" scaleMax="0" labelPerPart="0" obstacleFactor="1" fontMaxPixelSize="10000" obstacleType="1" drawLabels="1" fontLimitPixelSize="1" limitNumLabels="0" minFeatureSize="0" zIndex="0" upsidedownLabels="0" scaleMin="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Pie" attributeLegend="1">
    <DiagramCategory sizeType="MM" width="15" diagramOrientation="Up" backgroundColor="#ffffff" maxScaleDenominator="1e+08" scaleBasedVisibility="0" spacingUnit="MM" backgroundAlpha="255" rotationOffset="270" labelPlacementMethod="XHeight" direction="1" enabled="0" sizeScale="3x:0,0,0,0,0,0" barWidth="5" penColor="#000000" minScaleDenominator="1" penAlpha="255" scaleDependency="Area" penWidth="0" height="15" lineSizeScale="3x:0,0,0,0,0,0" spacingUnitScale="3x:0,0,0,0,0,0" opacity="1" spacing="0" lineSizeType="MM" minimumSize="0" showAxis="0">
  ...
  <DiagramLayerSettings obstacle="0" zIndex="0" placement="2" priority="0" showAll="1" linePlacementFlags="2" dist="0">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="PL.PZGiK.994.0401__OT_Ciek_nazwa">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="idMPHP" name="" index="23"/>
    <alias field="polozenie" name="" index="24"/>
    <alias field="szerokosc" name="" index="25"/>
    <alias field="szerokosc_uom" name="" index="26"/>
    <alias field="okresowosc" name="" index="27"/>
    <alias field="przebieg" name="" index="28"/>
    <alias field="statusEksploatacji" name="" index="29"/>
    <alias field="x_informDodatkowa" name="" index="30"/>
    <alias field="ciek1" name="" index="31"/>
    <alias field="PL.PZGiK.994.0401__OT_Ciek_nazwa" name="" index="32"/>
    <alias field="ciek1_tmp" name="" index="33"/>
    <alias field="KOD10K" name="" index="34"/>
    <alias field="X_RODZREPG" name="" index="35"/>
    <alias field="STATUSEKS" name="" index="36"/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="PL.PZGiK.994.0401__OT_Ciek_nazwa" applyOnUpdate="0"/>
    <default expression="" field="ciek1_tmp" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" unique_strength="0" field="idMPHP" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="polozenie" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="szerokosc" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="szerokosc_uom" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="okresowosc" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="przebieg" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="statusEksploatacji" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="x_informDodatkowa" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="ciek1" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="PL.PZGiK.994.0401__OT_Ciek_nazwa" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="ciek1_tmp" constraints="0" notnull_strength="0"/>
    ...
    <constraint exp_strength="0" unique_strength="0" field="STATUSEKS" constraints="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="idMPHP" desc="" exp=""/>
    <constraint field="polozenie" desc="" exp=""/>
    <constraint field="szerokosc" desc="" exp=""/>
    <constraint field="szerokosc_uom" desc="" exp=""/>
    <constraint field="okresowosc" desc="" exp=""/>
    <constraint field="przebieg" desc="" exp=""/>
    <constraint field="statusEksploatacji" desc="" exp=""/>
    <constraint field="x_informDodatkowa" desc="" exp=""/>
    <constraint field="ciek1" desc="" exp=""/>
    <constraint field="PL.PZGiK.994.0401__OT_Ciek_nazwa" desc="" exp=""/>
    <constraint field="ciek1_tmp" desc="" exp=""/>
    <constraint field="KOD10K" desc="" exp=""/>
    <constraint field="X_RODZREPG" desc="" exp=""/>
    <constraint field="STATUSEKS" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields>
    <field subType="0" comment="" expression=" regexp_substr(  &quot;ciek1&quot; ,'#(.*)')" name="ciek1_tmp" precision="0" length="0" type="10" typeName="string"/>
    <field subType="0" comment="" expression=" &quot;x_kodKarto10k&quot; " name="KOD10K" precision="0" length="0" type="10" typeName="string"/>
    <field subType="0" comment="" expression=" &quot;x_rodzajReprGeom&quot; " name="X_RODZREPG" precision="0" length="0" type="10" typeName="string"/>
    <field subType="0" comment="" expression=" &quot;statusEksploatacji&quot; " name="STATUSEKS" precision="0" length="0" type="10" typeName="string"/>
  </expressionfields>
  <attributeactions>
    <defaultAction value="{00000000-0000-0000-0000-000000000000}" key="Canvas"/>
  </attributeactions>
  <attributetableconfig sortExpression="&quot;KOD10K&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      <column width="-1" hidden="1" type="actions"/>
      <column width="-1" name="ciek1_tmp" hidden="0" type="field"/>
      ...
      <column width="-1" name="idMPHP" hidden="0" type="field"/>
      <column width="-1" name="polozenie" hidden="0" type="field"/>
      <column width="-1" name="szerokosc" hidden="0" type="field"/>
      <column width="-1" name="szerokosc_uom" hidden="0" type="field"/>
      <column width="-1" name="okresowosc" hidden="0" type="field"/>
      <column width="-1" name="przebieg" hidden="0" type="field"/>
      <column width="-1" name="statusEksploatacji" hidden="0" type="field"/>
      <column width="-1" name="x_informDodatkowa" hidden="0" type="field"/>
      <column width="-1" name="ciek1" hidden="1" type="field"/>
      <column width="-1" name="PL.PZGiK.994.0401__OT_Ciek_nazwa" hidden="1" type="field"/>
      <column width="-1" name="KOD10K" hidden="1" type="field"/>
      <column width="-1" name="X_RODZREPG" hidden="1" type="field"/>
      <column width="-1" name="STATUSEKS" hidden="1" type="field"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="0" name="OT_Ciek_nazwa"/>
    <field editable="0" name="PL.PZGiK.994.0401__OT_Ciek_nazwa"/>
    <field editable="0" name="PL.PZGiK.994.0464__OT_Ciek OT_Ciek_nazwa"/>
    <field editable="0" name="STATUSEKS"/>
    <field editable="0" name="X_RODZREPG"/>
    <field editable="1" name="ciek1"/>
    <field editable="0" name="ciek1_tmp"/>
  ...
  <labelOnTop>
    ...
    <field name="OT_Ciek_nazwa" labelOnTop="0"/>
    <field name="PL.PZGiK.994.0401__OT_Ciek_nazwa" labelOnTop="0"/>
    <field name="PL.PZGiK.994.0464__OT_Ciek OT_Ciek_nazwa" labelOnTop="0"/>
    <field name="STATUSEKS" labelOnTop="0"/>
    <field name="X_RODZREPG" labelOnTop="0"/>
    <field name="ciek1" labelOnTop="0"/>
    <field name="ciek1_tmp" labelOnTop="0"/>
    ...
    <field name="statusEksploatacji" labelOnTop="0"/>
    <field name="szerokosc" labelOnTop="0"/>
    <field name="szerokosc_uom" labelOnTop="0"/>

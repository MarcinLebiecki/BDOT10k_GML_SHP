...
<qgis maxScale="1000" simplifyAlgorithm="0" labelsEnabled="1" readOnly="1" hasScaleBasedVisibilityFlag="1" simplifyMaxScale="1" simplifyLocal="1" minScale="10001" version="3.12.1-București" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyDrawingHints="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontStrikeout="0" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" fontItalic="0" fontKerning="1" fieldName="CASE &#xd;&#xa;&#x9;WHEN &quot;KOD10K&quot;  = '0010_437' THEN 'N'&#xd;&#xa;&#x9;WHEN &quot;KOD10K&quot;  = '0010_438' THEN 'B'&#xd;&#xa;&#x9;WHEN &quot;KOD10K&quot;  = '0010_440' THEN 'G'&#xd;&#xa;&#x9;WHEN &quot;KOD10K&quot;  = '0010_441' THEN 'W'&#xd;&#xa;&#x9;WHEN &quot;KOD10K&quot;  = '0010_442' THEN 'C'&#xd;&#xa;&#x9;WHEN &quot;KOD10K&quot;  = '0010_443' THEN 'K'&#xd;&#xa;END" isExpression="1" textColor="78,74,150,255" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWeight="50" fontLetterSpacing="0" textOrientation="horizontal" blendMode="0" multilineHeight="1" namedStyle="Normal" useSubstitutions="0" fontFamily="Arial" fontCapitals="0" fontSizeUnit="MapUnit" textOpacity="1" fontSize="13">
        <text-buffer bufferJoinStyle="128" bufferBlendMode="0" bufferNoFill="0" bufferOpacity="1" bufferSizeUnits="MapUnit" bufferSize="5" bufferDraw="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255"/>
        <text-mask maskOpacity="1" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSize="1.5" maskSizeUnits="MapUnit" maskEnabled="0" maskedSymbolLayers="" maskJoinStyle="128" maskType="0"/>
      ...
      <placement rotationAngle="0" maxCurvedCharAngleIn="25" overrunDistance="0" layerType="LineGeometry" dist="0" placementFlags="9" offsetUnits="MM" repeatDistanceUnits="MapUnit" yOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" distUnits="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" priority="8" quadOffset="4" geometryGeneratorType="PointGeometry" preserveRotation="1" maxCurvedCharAngleOut="-25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" repeatDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" placement="2" centroidInside="0" xOffset="0" geometryGeneratorEnabled="0" centroidWhole="0" overrunDistanceUnit="MM" geometryGenerator=""/>
      <rendering fontMinPixelSize="3" scaleMin="0" maxNumLabels="2000" obstacleFactor="1" zIndex="0" scaleMax="0" drawLabels="1" obstacleType="1" scaleVisibility="0" fontLimitPixelSize="0" displayAll="0" mergeLines="1" labelPerPart="0" limitNumLabels="0" upsidedownLabels="0" obstacle="0" minFeatureSize="0" fontMaxPixelSize="10000"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option type="Map" name="properties">
            <Option type="Map" name="BufferSize">
              ...
              <Option value="CASE &#xd;&#xa;&#x9;WHEN &quot;x_kodKarto10k&quot;  = '0010_437' THEN 4&#xd;&#xa;&#x9;WHEN &quot;x_kodKarto10k&quot;  = '0010_438' THEN 4&#xd;&#xa;&#x9;WHEN &quot;x_kodKarto10k&quot;  = '0010_440' THEN 4&#xd;&#xa;&#x9;WHEN &quot;x_kodKarto10k&quot;  = '0010_441' THEN 4&#xd;&#xa;&#x9;WHEN &quot;x_kodKarto10k&quot;  = '0010_442' THEN 6&#xd;&#xa;&#x9;WHEN &quot;x_kodKarto10k&quot;  = '0010_443' THEN 4&#xd;&#xa;END" type="QString" name="expression"/>
  ...
  <aliases>
    ...
    <alias field="srPrzewodu" index="26" name=""/>
    <alias field="rodzaj" index="27" name=""/>
    <alias field="srPrzewodu_uom" index="28" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="srPrzewodu" expression=""/>
    <default applyOnUpdate="0" field="rodzaj" expression=""/>
    <default applyOnUpdate="0" field="srPrzewodu_uom" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="srPrzewodu" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" field="rodzaj" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" field="srPrzewodu_uom" constraints="0" notnull_strength="0" unique_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="srPrzewodu"/>
    <constraint exp="" desc="" field="rodzaj"/>
    <constraint exp="" desc="" field="srPrzewodu_uom"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="&quot;KOD10K&quot;" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" width="-1" name="srPrzewodu" hidden="0"/>
      <column type="field" width="-1" name="rodzaj" hidden="0"/>
      <column type="field" width="-1" name="srPrzewodu_uom" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="srPrzewodu"/>
    <field editable="1" name="srPrzewodu_uom"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="srPrzewodu"/>
    <field labelOnTop="0" name="srPrzewodu_uom"/>

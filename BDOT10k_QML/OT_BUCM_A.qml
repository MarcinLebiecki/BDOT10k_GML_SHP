...
<qgis maxScale="1000" simplifyAlgorithm="0" labelsEnabled="0" readOnly="1" hasScaleBasedVisibilityFlag="1" simplifyMaxScale="1" simplifyLocal="1" minScale="10001" version="3.12.1-București" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyDrawingHints="1">
  ...
  <renderer-v2 attr="KOD10K" enableorderby="0" forceraster="0" type="categorizedSymbol" symbollevels="0">
    <categories>
      <category symbol="0" value="0010_343_1" label="cmentarz chrześcijański (w skali)" render="true"/>
      <category symbol="1" value="0010_344_1" label="cmentarz niechrześcijański (w skali)" render="true"/>
      <category symbol="2" value="0010_345_1" label="cmentarz komunalny (w skali)" render="true"/>
      <category symbol="3" value="0010_346_1" label="cmentarz wojenny (w skali)" render="true"/>
      <category symbol="4" value="0010_347_1" label="cmentarz dla zwierząt (w skali)" render="true"/>
    </categories>
    <symbols>
        ...
        <layer locked="0" enabled="1" pass="0" class="PointPatternFill">
          ...
          <symbol clip_to_extent="1" force_rhr="0" type="marker" name="@0@1" alpha="1">
            <layer locked="0" enabled="1" pass="0" class="SvgMarker">
              ...
              <prop k="name" v="KARTO10k/0010_343_1.svg"/>
              <prop k="offset" v="15,30"/>
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MapUnit"/>
        ...
        <layer locked="0" enabled="1" pass="0" class="PointPatternFill">
          ...
          <symbol clip_to_extent="1" force_rhr="0" type="marker" name="@1@1" alpha="1">
            <layer locked="0" enabled="1" pass="0" class="SvgMarker">
              ...
              <prop k="fixedAspectRatio" v="0"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="KARTO10k/0010_344_1.svg"/>
              <prop k="offset" v="15,30"/>
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MapUnit"/>
              <prop k="outline_color" v="255,255,255,255"/>
        ...
        <layer locked="0" enabled="1" pass="0" class="PointPatternFill">
          ...
          <symbol clip_to_extent="1" force_rhr="0" type="marker" name="@2@1" alpha="1">
            <layer locked="0" enabled="1" pass="0" class="SvgMarker">
              ...
              <prop k="fixedAspectRatio" v="0"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="KARTO10k/0010_345_1.svg"/>
              <prop k="offset" v="12,24"/>
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MapUnit"/>
              <prop k="outline_color" v="255,255,255,255"/>
              <prop k="outline_width" v="0"/>
        ...
        <layer locked="0" enabled="1" pass="0" class="PointPatternFill">
          ...
          <symbol clip_to_extent="1" force_rhr="0" type="marker" name="@3@1" alpha="1">
            <layer locked="0" enabled="1" pass="0" class="SvgMarker">
              ...
              <prop k="fixedAspectRatio" v="0"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="KARTO10k/0010_346_1.svg"/>
              <prop k="offset" v="15,30"/>
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MapUnit"/>
              <prop k="outline_color" v="255,255,255,255"/>
        ...
        <layer locked="0" enabled="1" pass="0" class="PointPatternFill">
          ...
          <symbol clip_to_extent="1" force_rhr="0" type="marker" name="@4@1" alpha="1">
            <layer locked="0" enabled="1" pass="0" class="SvgMarker">
              ...
              <prop k="fixedAspectRatio" v="0"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="KARTO10k/0010_347_1.svg"/>
              <prop k="offset" v="15,30"/>
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MapUnit"/>
              <prop k="outline_color" v="255,255,255,255"/>
  ...
  <aliases>
    ...
    <alias field="wyznanie" index="27" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="wyznanie" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="wyznanie" constraints="0" notnull_strength="0" unique_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="wyznanie"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="&quot;KOD10K&quot;" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" width="-1" name="wyznanie" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="wyznanie"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="wyznanie"/>

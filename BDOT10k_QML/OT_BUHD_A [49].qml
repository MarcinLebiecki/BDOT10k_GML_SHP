...
<qgis hasScaleBasedVisibilityFlag="1" styleCategories="Symbology|Labeling|Fields|Rendering" maxScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyDrawingHints="1" simplifyDrawingTol="1" minScale="10001" simplifyLocal="1" version="3.22.11-Białowieża" symbologyReferenceScale="-1" labelsEnabled="0">
  <renderer-v2 forceraster="0" enableorderby="0" type="categorizedSymbol" attr="KOD10K" symbollevels="0" referencescale="-1">
    <categories>
      <category render="true" symbol="0" value="0010_616" label="zapora - 0010_616 (49)"/>
      <category render="true" symbol="1" value="0010_617_1" label="śluza (w skali) - 0010_617_1 (49)"/>
    </categories>
    <symbols>
      <symbol clip_to_extent="1" type="fill" name="0" force_rhr="0" alpha="1">
        ...
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option type="QString" name="line_width" value="5"/>
            <Option type="QString" name="line_width_unit" value="MapUnit"/>
            <Option type="QString" name="offset" value="-5"/>
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MapUnit"/>
            <Option type="QString" name="ring_filter" value="0"/>
            <Option type="QString" name="trim_distance_end" value="0"/>
  ...
  <fieldConfiguration>
    ...
    <field name="wysokoscZapory" configurationFlags="None"/>
    <field name="wysokoscZapory_uom" configurationFlags="None"/>
  ...
  <aliases>
    ...
    <alias name="" index="9" field="kodKarto10k"/>
    <alias name="" index="10" field="rodzaj"/>
    <alias name="" index="11" field="wysokoscZapory"/>
    <alias name="" index="12" field="wysokoscZapory_uom"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="wysokoscZapory"/>
    <default expression="" applyOnUpdate="0" field="wysokoscZapory_uom"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="wysokoscZapory"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="wysokoscZapory_uom"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="wysokoscZapory"/>
    <constraint exp="" desc="" field="wysokoscZapory_uom"/>

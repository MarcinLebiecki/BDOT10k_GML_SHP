...
<qgis hasScaleBasedVisibilityFlag="1" styleCategories="Symbology|Labeling|Fields|Rendering" maxScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyDrawingHints="1" simplifyDrawingTol="1" minScale="25001" simplifyLocal="1" version="3.22.11-Białowieża" symbologyReferenceScale="-1" labelsEnabled="0">
  <renderer-v2 forceraster="0" enableorderby="0" type="categorizedSymbol" attr="KOD10K" symbollevels="0" referencescale="-1">
    <categories>
      <category render="true" symbol="0" value="0010_128_1" label="alejka lub pasaż (w skali) - 0010_128_1 (47)"/>
      <category render="true" symbol="1" value="0010_128_2" label="alejka lub pasaż (symbol) - 0010_128_2 (47)"/>
      <category render="true" symbol="2" value="0010_129" label="ścieżka - 0010_129 (47)"/>
    </categories>
    <symbols>
      <symbol clip_to_extent="1" type="line" name="0" force_rhr="0" alpha="1">
        ...
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option type="QString" name="line_color" value="105,104,99,255"/>
      ...
      <symbol clip_to_extent="1" type="line" name="2" force_rhr="0" alpha="1">
        ...
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="flat"/>
            <Option type="QString" name="customdash" value="15;5"/>
            <Option type="QString" name="customdash_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="customdash_unit" value="MapUnit"/>
            <Option type="QString" name="dash_pattern_offset" value="0"/>
            <Option type="QString" name="dash_pattern_offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
  ...
  <aliases>
    ...
    <alias name="" index="10" field="materialNawierzchni"/>
    <alias name="" index="11" field="polozenie"/>
    <alias name="" index="12" field="identyfikatorSIMC"/>
    <alias name="" index="13" field="identyfikatorULIC"/>
    <alias name="" index="14" field="szerokosc"/>
    <alias name="" index="15" field="szerokosc_uom"/>
    <alias name="" index="16" field="ulicaCecha"/>
    <alias name="" index="17" field="ulicaNazwa1"/>
    <alias name="" index="18" field="ulicaNazwa2"/>
    <alias name="" index="19" field="informacjaDodatkowa"/>

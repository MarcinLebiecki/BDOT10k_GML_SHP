...
<qgis minScale="10001" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyDrawingHints="1" readOnly="1" version="3.12.0-București" labelsEnabled="0" maxScale="1000" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" simplifyMaxScale="1">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" type="categorizedSymbol" forceraster="0" attr="X_KODKARTO10K">
    <categories>
      <category symbol="0" label="zapora wodna" value="0010_616" render="true"/>
      <category symbol="1" label="jaz stały" value="0010_618" render="true"/>
      <category symbol="2" label="jaz ruchomy lub zastawka piętrząca" value="0010_620" render="true"/>
    </categories>
    <symbols>
    ...
    <source-symbol>
      <symbol alpha="1" type="line" force_rhr="0" clip_to_extent="1" name="0">
        <layer locked="0" enabled="1" pass="0" class="SimpleLine">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="200,143,89,255"/>
          <prop k="line_style" v="solid"/>
  ...
  <DiagramLayerSettings showAll="1" linePlacementFlags="2" placement="2" dist="0" zIndex="0" priority="0" obstacle="0">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="poziomWodyMaksymalny">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="poziomWodyMinimalny">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="wysokoscKoronyZapory">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="poziomWodyMaksymalny" index="26" name=""/>
    <alias field="poziomWodyMinimalny" index="27" name=""/>
    <alias field="wysokoscKoronyZapory" index="28" name=""/>
    <alias field="koniecWersjiObiektu" index="29" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="poziomWodyMaksymalny" expression=""/>
    <default applyOnUpdate="0" field="poziomWodyMinimalny" expression=""/>
    <default applyOnUpdate="0" field="wysokoscKoronyZapory" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="rodzaj" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="poziomWodyMaksymalny" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="poziomWodyMinimalny" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="wysokoscKoronyZapory" notnull_strength="0" unique_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="poziomWodyMaksymalny" exp="" desc=""/>
    <constraint field="poziomWodyMinimalny" exp="" desc=""/>
    <constraint field="wysokoscKoronyZapory" exp="" desc=""/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      <column type="field" hidden="0" width="-1" name="rodzaj"/>
      ...
      <column type="field" hidden="0" width="-1" name="wysokoscKoronyZapory"/>
      <column type="field" hidden="0" width="-1" name="x_doklGeom"/>
      <column type="field" hidden="0" width="-1" name="x_doklGeom_uom"/>
      <column type="field" hidden="0" width="-1" name="poziomWodyMaksymalny"/>
      <column type="field" hidden="0" width="-1" name="poziomWodyMinimalny"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="poziomWodyMaksymalny"/>
    <field editable="1" name="poziomWodyMinimalny"/>
    <field editable="1" name="przestrzenNazw"/>
    <field editable="1" name="rodzaj"/>
    <field editable="1" name="wersjaId"/>
    <field editable="1" name="wysokoscKoronyZapory"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="poziomWodyMaksymalny"/>
    <field labelOnTop="0" name="poziomWodyMinimalny"/>
    <field labelOnTop="0" name="przestrzenNazw"/>
    <field labelOnTop="0" name="rodzaj"/>
    <field labelOnTop="0" name="wersjaId"/>
    <field labelOnTop="0" name="wysokoscKoronyZapory"/>

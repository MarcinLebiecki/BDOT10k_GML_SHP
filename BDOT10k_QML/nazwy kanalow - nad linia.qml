...
<qgis simplifyDrawingTol="1" simplifyLocal="1" hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyAlgorithm="0" minScale="10001" simplifyDrawingHints="1" maxScale="1000" readOnly="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" version="3.12.1-București">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontStrikeout="0" blendMode="0" useSubstitutions="0" isExpression="1" fontWeight="50" textOpacity="1" fontKerning="1" fontSize="22" fontFamily="Cambria" fontSizeUnit="MapUnit" previewBkgrdColor="255,255,255,255" fontLetterSpacing="0" textColor="83,174,221,255" fontItalic="1" multilineHeight="1" fieldName="if (&quot;KOD10K&quot; IN ( '0010_606', '0010_610') AND  (&quot;POLOZENIE&quot; != '-1' OR &quot;POLOZENIE&quot; != 'podPowierzchnia'), if ( (&quot;STATUSEKS&quot; = 'Z' OR &quot;STATUSEKS&quot; = 'zeglowny'), upper( &quot;CIEK_NAZWA&quot; ), &quot;CIEK_NAZWA&quot; ),'')" textOrientation="horizontal" namedStyle="Italic" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontCapitals="0" fontUnderline="0" fontWordSpacing="0">
        <text-buffer bufferSizeUnits="MM" bufferNoFill="0" bufferOpacity="1" bufferJoinStyle="64" bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferColor="255,255,255,255" bufferBlendMode="0"/>
      ...
      <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetUnits="MapUnit" yOffset="0" distUnits="MM" layerType="LineGeometry" geometryGeneratorEnabled="0" preserveRotation="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="3" dist="0" centroidInside="0" overrunDistanceUnit="MM" quadOffset="4" maxCurvedCharAngleOut="-20" maxCurvedCharAngleIn="20" priority="5" overrunDistance="0" distMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" offsetType="0" xOffset="0" placementFlags="10" centroidWhole="0" geometryGenerator="" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" repeatDistanceUnits="MM" rotationAngle="0" repeatDistance="0"/>
      <rendering obstacle="1" maxNumLabels="2000" mergeLines="1" displayAll="0" fontMinPixelSize="3" scaleVisibility="0" scaleMax="10000000" labelPerPart="0" obstacleFactor="1" fontMaxPixelSize="10000" obstacleType="0" drawLabels="1" fontLimitPixelSize="0" limitNumLabels="0" minFeatureSize="0" zIndex="0" upsidedownLabels="0" scaleMin="1"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties" type="Map">
            <Option name="Size" type="Map">
              ...
              <Option value="if(&quot;STATUSEKS&quot;  = 'Z' OR &quot;STATUSEKS&quot; = 'zeglowny', 22, 18)" name="expression" type="QString"/>
  ...
  <aliases>
    ...
    <alias field="ciek1_tmp" name="" index="32"/>
    <alias field="KOD10K" name="" index="33"/>
    <alias field="STATUSEKS" name="" index="34"/>
  </aliases>
  ...
  <attributetableconfig sortExpression="&quot;STATUSEKS&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column width="212" name="ciek1" hidden="1" type="field"/>
      <column width="-1" name="ciek1_tmp" hidden="1" type="field"/>

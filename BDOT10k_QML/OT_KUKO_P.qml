...
<qgis simplifyMaxScale="1" maxScale="1000" styleCategories="AllStyleCategories" minScale="10001" readOnly="1" hasScaleBasedVisibilityFlag="1" version="3.12.1-București" simplifyAlgorithm="0" labelsEnabled="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyDrawingHints="0">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 type="categorizedSymbol" attr="X_KODKARTO10K" enableorderby="0" symbollevels="0" forceraster="0">
    <categories>
      <category symbol="0" label="dworzec autobusowy" value="0010_142" render="true"/>
    </categories>
    <symbols>
      <symbol force_rhr="0" type="marker" name="0" alpha="1" clip_to_extent="1">
        <layer pass="0" locked="0" enabled="1" class="SvgMarker">
          ...
          <prop v="KARTO10k/0010_142.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Pie">
    <DiagramCategory sizeType="MM" direction="1" showAxis="0" height="15" lineSizeScale="3x:0,0,0,0,0,0" maxScaleDenominator="1e+08" backgroundAlpha="255" opacity="1" minScaleDenominator="1" spacingUnitScale="3x:0,0,0,0,0,0" sizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" spacing="0" rotationOffset="270" spacingUnit="MM" diagramOrientation="Up" minimumSize="0" scaleDependency="Area" scaleBasedVisibility="0" width="15" penWidth="0" backgroundColor="#ffffff" lineSizeType="MM" barWidth="5" penAlpha="255" enabled="0" penColor="#000000">
  ...
  <DiagramLayerSettings placement="0" obstacle="0" linePlacementFlags="2" dist="0" priority="0" zIndex="0" showAll="1">
    <properties>
      <Option type="Map">
        <Option type="QString" name="name" value=""/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias name="" field="x_informDodatkowa" index="18"/>
    <alias name="" field="x_kodKarto10k" index="19"/>
    <alias name="" field="x_kodKarto25k" index="20"/>
    <alias name="" field="x_kodKarto50k" index="21"/>
    <alias name="" field="x_kodKarto100k" index="22"/>
    <alias name="" field="x_kodKarto250k" index="23"/>
    <alias name="" field="x_kodKarto500k" index="24"/>
    <alias name="" field="x_kodKarto1000k" index="25"/>
  </aliases>
  ...
  <constraints>
    <constraint exp_strength="0" constraints="1" field="gml_id" unique_strength="0" notnull_strength="1"/>
    ...
    <constraint exp_strength="0" constraints="0" field="czyObiektBDOO" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_kod" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_skrKarto" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_katDoklGeom" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_doklGeom" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_doklGeom_uom" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_zrodloDanychG" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_zrodloDanychA" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_katIstnienia" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_rodzajReprGeom" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_aktualnoscG" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_aktualnoscA" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="poczatekWersjiObiektu" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_dataUtworzenia" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_informDodatkowa" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_kodKarto10k" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_kodKarto25k" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_kodKarto50k" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_kodKarto100k" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_kodKarto250k" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_kodKarto500k" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" constraints="0" field="x_kodKarto1000k" unique_strength="0" notnull_strength="0"/>
  </constraints>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="czyObiektBDOO" width="-1" hidden="0"/>
      <column type="field" name="x_kod" width="-1" hidden="0"/>
      <column type="field" name="x_skrKarto" width="-1" hidden="0"/>
      <column type="field" name="x_katDoklGeom" width="-1" hidden="0"/>
      <column type="field" name="x_zrodloDanychG" width="-1" hidden="0"/>
      <column type="field" name="x_zrodloDanychA" width="-1" hidden="0"/>
      <column type="field" name="x_katIstnienia" width="-1" hidden="0"/>
      <column type="field" name="x_rodzajReprGeom" width="-1" hidden="0"/>
      <column type="field" name="x_aktualnoscG" width="-1" hidden="0"/>
      <column type="field" name="x_aktualnoscA" width="-1" hidden="0"/>
      <column type="field" name="poczatekWersjiObiektu" width="-1" hidden="0"/>
      <column type="field" name="x_dataUtworzenia" width="-1" hidden="0"/>
      <column type="field" name="x_kodKarto10k" width="-1" hidden="0"/>
      <column type="field" name="x_kodKarto25k" width="-1" hidden="0"/>
      <column type="field" name="x_kodKarto50k" width="-1" hidden="0"/>
      <column type="field" name="x_kodKarto100k" width="-1" hidden="0"/>
      ...
      <column type="field" name="x_doklGeom" width="-1" hidden="0"/>
      <column type="field" name="x_doklGeom_uom" width="-1" hidden="0"/>

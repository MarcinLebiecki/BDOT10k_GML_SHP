...
<qgis simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyDrawingTol="1" labelsEnabled="1" version="3.12.1-București" minScale="10001" readOnly="1" hasScaleBasedVisibilityFlag="1" maxScale="1000" simplifyDrawingHints="1" simplifyLocal="1" simplifyMaxScale="1">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" attr="KOD10K" type="categorizedSymbol">
    <categories>
      <category symbol="0" label="stadion" value="0010_338" render="true"/>
      <category symbol="1" label="basen kąpielowy" value="0010_611" render="true"/>
      <category symbol="2" label="skocznia narciarska (w skali)" value="0010_341_1" render="true"/>
    </categories>
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontKerning="1" blendMode="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" fontSize="18" textOpacity="1" fontWordSpacing="0" namedStyle="Italic" fieldName=" if( NAZWA is not null, NAZWA, X_SKRKARTO ) " fontSizeUnit="MapUnit" fontLetterSpacing="0" useSubstitutions="1" fontStrikeout="0" textColor="0,0,0,255" multilineHeight="1" fontFamily="Arial" fontCapitals="0" fontUnderline="0" fontItalic="1" fontWeight="50" isExpression="1">
        <text-buffer bufferOpacity="0.5" bufferDraw="0" bufferBlendMode="0" bufferColor="255,255,255,255" bufferSize="2.2" bufferJoinStyle="128" bufferSizeUnits="MapUnit" bufferNoFill="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0"/>
        ...
        <background shapeSizeType="0" shapeSizeUnit="MM" shapeRadiiY="0" shapeRotation="0" shapeType="0" shapeRadiiUnit="MM" shapeBorderWidth="0" shapeRotationType="0" shapeRadiiX="0" shapeJoinStyle="64" shapeBorderWidthUnit="MM" shapeSizeX="0" shapeSizeY="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeOffsetX="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSVGFile="" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeOpacity="1" shapeOffsetUnit="MM" shapeFillColor="255,255,255,255" shapeBlendMode="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0">
        ...
        <substitutions>
          <replacement match="Klub Sportowy" caseSensitive="0" replace="KS" wholeWord="1"/>
        </substitutions>
      </text-style>
      <text-format wrapChar=" " addDirectionSymbol="0" placeDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" autoWrapLength="0" multilineAlign="1" rightDirectionSymbol=">" useMaxLineLengthForAutoWrap="1" decimals="3" plussign="0" reverseDirectionSymbol="0"/>
      <placement offsetType="0" centroidWhole="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistanceUnits="MM" geometryGeneratorEnabled="0" centroidInside="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" rotationAngle="0" distUnits="MM" priority="5" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" maxCurvedCharAngleOut="-20" overrunDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placement="1" dist="0" preserveRotation="1" fitInPolygonOnly="0" placementFlags="10" layerType="PolygonGeometry" quadOffset="4" offsetUnits="MapUnit" geometryGenerator="" xOffset="0" maxCurvedCharAngleIn="20" yOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0"/>
      <rendering labelPerPart="0" limitNumLabels="0" displayAll="0" fontLimitPixelSize="0" maxNumLabels="2000" obstacle="1" fontMinPixelSize="3" minFeatureSize="0" scaleMax="10000000" obstacleType="0" obstacleFactor="1" zIndex="0" drawLabels="1" scaleVisibility="0" fontMaxPixelSize="10000" upsidedownLabels="0" mergeLines="0" scaleMin="1"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties" type="Map">
            <Option name="Color" type="Map">
              ...
              <Option value="IF(&quot;x_skrKarto&quot; = 'bas. kąp.','#53afdd','#000000')" name="expression" type="QString"/>

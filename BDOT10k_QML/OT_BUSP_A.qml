...
<qgis maxScale="1000" simplifyAlgorithm="0" labelsEnabled="1" readOnly="1" hasScaleBasedVisibilityFlag="1" simplifyMaxScale="1" simplifyLocal="1" minScale="10001" version="3.12.1-București" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyDrawingHints="1">
  ...
  <renderer-v2 attr="KOD10K" enableorderby="0" forceraster="0" type="categorizedSymbol" symbollevels="0">
    <categories>
      <category symbol="0" value="0010_338" label="stadion" render="true"/>
      <category symbol="1" value="0010_611" label="basen kąpielowy" render="true"/>
      <category symbol="2" value="0010_341_1" label="skocznia narciarska (w skali)" render="true"/>
    </categories>
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontStrikeout="0" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" fontItalic="1" fontKerning="1" fieldName=" if( NAZWA is not null, NAZWA, X_SKRKARTO ) " isExpression="1" textColor="0,0,0,255" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWeight="50" fontLetterSpacing="0" textOrientation="horizontal" blendMode="0" multilineHeight="1" namedStyle="Italic" useSubstitutions="1" fontFamily="Arial" fontCapitals="0" fontSizeUnit="MapUnit" textOpacity="1" fontSize="18">
        <text-buffer bufferJoinStyle="128" bufferBlendMode="0" bufferNoFill="0" bufferOpacity="0.5" bufferSizeUnits="MapUnit" bufferSize="2.2" bufferDraw="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255"/>
        ...
        <substitutions>
          <replacement caseSensitive="0" replace="KS" match="Klub Sportowy" wholeWord="1"/>
        </substitutions>
      </text-style>
      ...
      <placement rotationAngle="0" maxCurvedCharAngleIn="20" overrunDistance="0" layerType="PolygonGeometry" dist="0" placementFlags="10" offsetUnits="MapUnit" repeatDistanceUnits="MM" yOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" distUnits="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" priority="5" quadOffset="4" geometryGeneratorType="PointGeometry" preserveRotation="1" maxCurvedCharAngleOut="-20" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" repeatDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" placement="1" centroidInside="0" xOffset="0" geometryGeneratorEnabled="0" centroidWhole="0" overrunDistanceUnit="MM" geometryGenerator=""/>
        ...
        <Option type="Map">
          ...
          <Option type="Map" name="properties">
            <Option type="Map" name="Color">
              ...
              <Option value="IF(&quot;x_skrKarto&quot; = 'bas. kąp.','#53afdd','#000000')" type="QString" name="expression"/>

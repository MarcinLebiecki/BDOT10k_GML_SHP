...
<qgis simplifyDrawingTol="1" version="3.12.1-București" simplifyDrawingHints="1" simplifyAlgorithm="0" simplifyLocal="1" maxScale="1000" labelsEnabled="0" minScale="10001" readOnly="1" styleCategories="AllStyleCategories" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1">
  ...
  <renderer-v2 symbollevels="0" attr="KOD10K" enableorderby="0" type="categorizedSymbol" forceraster="0">
    <categories>
      <category value="0010_136" symbol="0" render="true" label="zejście do przejścia podziemnego"/>
    </categories>
    <symbols>
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0">
          ...
          <symbol force_rhr="0" clip_to_extent="1" name="@0@0" alpha="1" type="marker">
            <layer class="SvgMarker" pass="0" enabled="1" locked="0">
              ...
              <prop k="name" v="KARTO10k/0010_136.svg"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MapUnit"/>
    ...
    <sizescale/>
    <orderby>
      <orderByClause asc="1" nullsFirst="0">"SYS_ID"</orderByClause>
    </orderby>
  </renderer-v2>
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style multilineHeight="1" fontItalic="1" isExpression="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWordSpacing="0" blendMode="0" previewBkgrdColor="255,255,255,255" fontLetterSpacing="0" fontKerning="1" fontCapitals="0" textOpacity="1" textColor="0,0,0,255" fontUnderline="0" fontWeight="50" textOrientation="horizontal" useSubstitutions="0" fontSizeUnit="MapUnit" namedStyle="Italic" fontSize="18" fieldName=" if(  &quot;B_DLUGOSC&quot; > 200, B_NAZWA, '')" fontFamily="Arial" fontStrikeout="0">

...
<qgis maxScale="10001" simplifyAlgorithm="0" labelsEnabled="0" readOnly="1" hasScaleBasedVisibilityFlag="1" simplifyMaxScale="1" simplifyLocal="1" minScale="1000000" version="3.12.1-București" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyDrawingHints="1">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 attr="KOD100K" enableorderby="0" forceraster="0" type="categorizedSymbol" symbollevels="0">
    <categories>
      <category symbol="0" value="0100_312" label="zabudowa wielorodzinna zwarta" render="true"/>
      <category symbol="1" value="0100_314" label="zabudowa wielorodzinna gęsta lub luźna" render="true"/>
      <category symbol="2" value="0100_315" label="zabudowa jednorodzinna" render="true"/>
    </categories>
    <symbols>
      <symbol clip_to_extent="1" force_rhr="0" type="fill" name="0" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SimpleFill">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="163,65,0,255"/>
  ...
  <aliases>
    ...
    <alias field="charakter" index="25" name=""/>
    <alias field="rodzaj" index="26" name=""/>
    <alias field="roslinnosc" index="27" name=""/>
    <alias field="KOD100K" index="28" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="charakter" expression=""/>
    <default applyOnUpdate="0" field="rodzaj" expression=""/>
    <default applyOnUpdate="0" field="roslinnosc" expression=""/>
    <default applyOnUpdate="0" field="KOD100K" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint exp_strength="0" field="charakter" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" field="rodzaj" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" field="roslinnosc" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" field="KOD100K" constraints="0" notnull_strength="0" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="KOD100K"/>
  </constraintExpressions>
  <expressionfields>
    <field comment="" precision="0" subType="0" length="0" expression=" &quot;x_kodKarto100k&quot; " type="10" typeName="string" name="KOD100K"/>
  </expressionfields>
  <attributeactions>
    <defaultAction key="Canvas" value="{00000000-0000-0000-0000-000000000000}"/>
  </attributeactions>
  <attributetableconfig sortOrder="0" sortExpression="&quot;KOD100K&quot;" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" width="-1" name="charakter" hidden="0"/>
      <column type="field" width="-1" name="roslinnosc" hidden="0"/>
      <column type="field" width="-1" name="x_doklGeom" hidden="0"/>
      <column type="field" width="-1" name="x_doklGeom_uom" hidden="0"/>
      <column type="field" width="-1" name="KOD100K" hidden="1"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field editable="0" name="KOD100K"/>
    <field editable="1" name="charakter"/>
    ...
    <field editable="1" name="roslinnosc"/>

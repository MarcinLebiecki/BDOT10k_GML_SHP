...
<qgis hasScaleBasedVisibilityFlag="1" styleCategories="Symbology|Labeling|Fields|Rendering" maxScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyDrawingHints="1" simplifyDrawingTol="1" minScale="25001" simplifyLocal="1" version="3.22.11-Białowieża" symbologyReferenceScale="-1" labelsEnabled="0">
  <renderer-v2 forceraster="0" enableorderby="0" type="categorizedSymbol" attr="KOD10K" symbollevels="0" referencescale="-1">
    <categories>
      <category render="true" symbol="0" value="0010_401" label="teren przemysłowo-składowy - 0010_401 (4)"/>
    </categories>
    <symbols>
      <symbol clip_to_extent="1" type="fill" name="0" force_rhr="0" alpha="1">
        ...
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option type="QString" name="color" value="226,224,239,255"/>
    ...
    <source-symbol>
      <symbol clip_to_extent="1" type="fill" name="0" force_rhr="0" alpha="1">
        ...
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="color" value="238,24,27,255"/>
  ...
  <fieldConfiguration>
    ...
    <field name="kopalina" configurationFlags="None"/>
    <field name="rodzajElektrowni" configurationFlags="None"/>
  ...
  <aliases>
    ...
    <alias name="" index="7" field="informacjaDodatkowa"/>
    ...
    <alias name="" index="12" field="kopalina"/>
    <alias name="" index="13" field="rodzajElektrowni"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="kopalina"/>
    <default expression="" applyOnUpdate="0" field="rodzajElektrowni"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="kopalina"/>
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="rodzajElektrowni"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="kopalina"/>
    <constraint exp="" desc="" field="rodzajElektrowni"/>

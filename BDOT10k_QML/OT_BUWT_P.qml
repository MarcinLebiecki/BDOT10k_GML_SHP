...
<qgis maxScale="1000" simplifyAlgorithm="0" labelsEnabled="1" readOnly="1" hasScaleBasedVisibilityFlag="1" simplifyMaxScale="1" simplifyLocal="1" minScale="10001" version="3.12.1-București" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyDrawingHints="0">
  ...
  <renderer-v2 attr="KOD10K" enableorderby="0" forceraster="0" type="categorizedSymbol" symbollevels="0">
    <categories>
      <category symbol="0" value="0010_334" label="wieża" render="true"/>
      <category symbol="1" value="0010_411" label="szyb kopalniany" render="true"/>
      <category symbol="2" value="0010_424" label="komin przemysłowy" render="true"/>
      <category symbol="3" value="0010_425" label="turbina wiatrowa" render="true"/>
      <category symbol="4" value="0010_426" label="maszt lub wieża telekomunikacyjna" render="true"/>
      <category symbol="5" value="0010_428" label="słup energetyczny lub podpora kolei liniowej" render="true"/>
      <category symbol="6" value="0010_429" label="maszt oświetleniowy" render="true"/>
    </categories>
    <symbols>
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="0" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          ...
          <prop k="name" v="KARTO10k/0010_334.svg"/>
          <prop k="offset" v="0,-10.99999999999999289"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="1" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_411.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="2" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_424.svg"/>
          <prop k="offset" v="0,-11.00000000000000355"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
          <prop k="outline_width" v="0"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="3" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_425.svg"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="4" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_426.svg"/>
          <prop k="offset" v="0,-11.00000000000001066"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
          <prop k="outline_width" v="0"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="6" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_429.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontStrikeout="0" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" fontItalic="0" fontKerning="1" fieldName="x_skrKarto" isExpression="0" textColor="0,0,0,255" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWeight="50" fontLetterSpacing="0" textOrientation="horizontal" blendMode="0" multilineHeight="1" namedStyle="Normal" useSubstitutions="0" fontFamily="MS Shell Dlg 2" fontCapitals="0" fontSizeUnit="MapUnit" textOpacity="1" fontSize="15">
        <text-buffer bufferJoinStyle="64" bufferBlendMode="0" bufferNoFill="0" bufferOpacity="1" bufferSizeUnits="MM" bufferSize="1" bufferDraw="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255"/>
        <text-mask maskOpacity="1" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskSize="1.5" maskSizeUnits="MM" maskEnabled="0" maskedSymbolLayers="" maskJoinStyle="64" maskType="0"/>
      ...
      <placement rotationAngle="0" maxCurvedCharAngleIn="20" overrunDistance="0" layerType="PointGeometry" dist="0" placementFlags="10" offsetUnits="MapUnit" repeatDistanceUnits="MM" yOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" distUnits="MapUnit" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" priority="5" quadOffset="4" geometryGeneratorType="PointGeometry" preserveRotation="1" maxCurvedCharAngleOut="-20" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" repeatDistance="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" placement="0" centroidInside="0" xOffset="0" geometryGeneratorEnabled="0" centroidWhole="0" overrunDistanceUnit="MM" geometryGenerator=""/>
      <rendering fontMinPixelSize="3" scaleMin="1" maxNumLabels="2000" obstacleFactor="1" zIndex="0" scaleMax="10000000" drawLabels="1" obstacleType="0" scaleVisibility="0" fontLimitPixelSize="0" displayAll="0" mergeLines="0" labelPerPart="0" limitNumLabels="0" upsidedownLabels="0" obstacle="1" minFeatureSize="0" fontMaxPixelSize="10000"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias field="wysokosc" index="26" name=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="wysokosc" constraints="0" notnull_strength="0" unique_strength="0"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="&quot;KOD10K&quot;" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" width="-1" name="wysokosc" hidden="0"/>

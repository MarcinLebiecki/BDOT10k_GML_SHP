...
<qgis maxScale="0" symbologyReferenceScale="-1" simplifyDrawingTol="1" simplifyMaxScale="1" styleCategories="Symbology|Symbology3D|Labeling|Fields|Forms|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend|Elevation|Notes" hasScaleBasedVisibilityFlag="1" minScale="10001" simplifyAlgorithm="0" simplifyLocal="1" labelsEnabled="1" simplifyDrawingHints="1" version="3.22.15-Białowieża">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textOpacity="0.90000000000000002" fontKerning="1" legendString="Aa" allowHtml="0" textColor="167,168,170,255" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSize="25.5" isExpression="1" fontFamily="Arial Narrow" fontSizeUnit="MapUnit" blendMode="0" fieldName="if($length>500,wysokosc,'')" useSubstitutions="0" textOrientation="horizontal" capitalization="0" fontWeight="75" multilineHeight="1" fontUnderline="0" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" fontLetterSpacing="0" namedStyle="Bold" fontItalic="0">
        <families/>
      ...
      <placement geometryGenerator="" dist="0" polygonPlacementFlags="2" overrunDistance="0" lineAnchorClipping="1" offsetUnits="MM" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="2" yOffset="0" lineAnchorPercent="0.5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationUnit="AngleDegrees" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" placementFlags="9" maxCurvedCharAngleOut="-25" fitInPolygonOnly="0" geometryGeneratorEnabled="0" xOffset="0" centroidInside="0" repeatDistance="0" offsetType="0" preserveRotation="1" geometryGeneratorType="PointGeometry" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" overrunDistanceUnit="MM" placement="2" distUnits="MM" centroidWhole="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="LineGeometry" quadOffset="4"/>
      <rendering minFeatureSize="0" scaleMax="0" scaleMin="0" displayAll="0" fontMinPixelSize="3" zIndex="0" scaleVisibility="0" labelPerPart="0" unplacedVisibility="0" upsidedownLabels="0" maxNumLabels="2000" obstacleFactor="1" obstacle="1" limitNumLabels="0" fontMaxPixelSize="10000" mergeLines="0" obstacleType="1" drawLabels="1" fontLimitPixelSize="1"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>

...
<qgis maxScale="1000" simplifyAlgorithm="0" labelsEnabled="0" readOnly="1" hasScaleBasedVisibilityFlag="1" simplifyMaxScale="1" simplifyLocal="1" minScale="10001" version="3.12.1-București" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyDrawingHints="1">
  ...
  <renderer-v2 attr="KOD10K" enableorderby="0" forceraster="0" type="categorizedSymbol" symbollevels="0">
    <categories>
      <category symbol="0" value="0010_614" label="wodospad" render="true"/>
      <category symbol="1" value="0010_615" label="próg skalny" render="true"/>
      <category symbol="2" value="0010_711" label="linia oddziałowa" render="true"/>
      <category symbol="3" value="0010_729" label="rząd drzew" render="true"/>
      <category symbol="4" value="0010_730" label="rząd drzew przy cieku, dordze lub linii kolejowej" render="true"/>
      <category symbol="5" value="0010_733" label="pas krzewów lub żywopłot" render="true"/>
    </categories>
    <symbols>

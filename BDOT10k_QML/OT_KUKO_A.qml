...
<qgis maxScale="1000" simplifyAlgorithm="0" labelsEnabled="0" readOnly="1" hasScaleBasedVisibilityFlag="1" simplifyMaxScale="1" simplifyLocal="1" minScale="10001" version="3.12.1-București" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyDrawingHints="1">
  ...
  <renderer-v2 attr="KOD10K" enableorderby="0" forceraster="0" type="categorizedSymbol" symbollevels="0">
    <categories>
      <category symbol="0" value="0010_142" label="dworzec autobusowy" render="true"/>
    </categories>
    <symbols>
        ...
        <layer locked="0" enabled="1" pass="0" class="CentroidFill">
          ...
          <symbol clip_to_extent="1" force_rhr="0" type="marker" name="@0@0" alpha="1">
            <layer locked="0" enabled="1" pass="0" class="SvgMarker">
              ...
              <prop k="name" v="KARTO10k/0010_142.svg"/>
              <prop k="offset" v="0,0"/>
  ...
  <fieldConfiguration>
    ...
    <field name="PL.PZGiK.238.2476__OT_Lotnisko_idIata">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="PL.PZGiK.238.2476__OT_Lotnisko_idIcao">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="PL.PZGiK.238.2476__OT_Lotnisko_rodzaj">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="port" index="29" name=""/>
    <alias field="PL.PZGiK.238.2476__OT_Lotnisko_idIata" index="30" name=""/>
    <alias field="PL.PZGiK.238.2476__OT_Lotnisko_idIcao" index="31" name=""/>
    <alias field="PL.PZGiK.238.2476__OT_Lotnisko_rodzaj" index="32" name=""/>
    <alias field="port_tmp" index="33" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="port" expression=""/>
    <default applyOnUpdate="0" field="PL.PZGiK.238.2476__OT_Lotnisko_idIata" expression=""/>
    <default applyOnUpdate="0" field="PL.PZGiK.238.2476__OT_Lotnisko_idIcao" expression=""/>
    <default applyOnUpdate="0" field="PL.PZGiK.238.2476__OT_Lotnisko_rodzaj" expression=""/>
    <default applyOnUpdate="0" field="port_tmp" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="port" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" field="PL.PZGiK.238.2476__OT_Lotnisko_idIata" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" field="PL.PZGiK.238.2476__OT_Lotnisko_idIcao" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" field="PL.PZGiK.238.2476__OT_Lotnisko_rodzaj" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" field="port_tmp" constraints="0" notnull_strength="0" unique_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="port"/>
    <constraint exp="" desc="" field="PL.PZGiK.238.2476__OT_Lotnisko_idIata"/>
    <constraint exp="" desc="" field="PL.PZGiK.238.2476__OT_Lotnisko_idIcao"/>
    <constraint exp="" desc="" field="PL.PZGiK.238.2476__OT_Lotnisko_rodzaj"/>
    <constraint exp="" desc="" field="port_tmp"/>
    <constraint exp="" desc="" field="KOD10K"/>
  </constraintExpressions>
  <expressionfields>
    <field comment="" precision="0" subType="0" length="0" expression="regexp_substr(port,'#(.*)')" type="10" typeName="string" name="port_tmp"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="&quot;KOD10K&quot;" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" width="188" name="port" hidden="0"/>
      <column type="field" width="-1" name="port_tmp" hidden="1"/>
      <column type="field" width="-1" name="PL.PZGiK.238.2476__OT_Lotnisko_idIata" hidden="0"/>
      <column type="field" width="-1" name="PL.PZGiK.238.2476__OT_Lotnisko_idIcao" hidden="0"/>
      <column type="field" width="-1" name="PL.PZGiK.238.2476__OT_Lotnisko_rodzaj" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="0" name="PL.PZGiK.238.2476__OT_Lotnisko_idIata"/>
    <field editable="0" name="PL.PZGiK.238.2476__OT_Lotnisko_idIcao"/>
    <field editable="0" name="PL.PZGiK.238.2476__OT_Lotnisko_rodzaj"/>
    <field editable="0" name="PL.PZGiK.330.1465__OT_Lotnisko_idIata"/>
    <field editable="0" name="PL.PZGiK.330.1465__OT_Lotnisko_idIcao"/>
    <field editable="0" name="PL.PZGiK.330.1465__OT_Lotnisko_rodzaj"/>
    ...
    <field editable="0" name="port_tmp"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="PL.PZGiK.238.2476__OT_Lotnisko_idIata"/>
    <field labelOnTop="0" name="PL.PZGiK.238.2476__OT_Lotnisko_idIcao"/>
    <field labelOnTop="0" name="PL.PZGiK.238.2476__OT_Lotnisko_rodzaj"/>
    <field labelOnTop="0" name="PL.PZGiK.330.1465__OT_Lotnisko_idIata"/>
    <field labelOnTop="0" name="PL.PZGiK.330.1465__OT_Lotnisko_idIcao"/>
    <field labelOnTop="0" name="PL.PZGiK.330.1465__OT_Lotnisko_rodzaj"/>
    ...
    <field labelOnTop="0" name="port_tmp"/>

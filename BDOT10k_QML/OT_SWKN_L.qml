...
<qgis simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyDrawingTol="2" labelsEnabled="0" version="3.12.1-București" minScale="10001" readOnly="1" hasScaleBasedVisibilityFlag="1" maxScale="1000" simplifyDrawingHints="3" simplifyLocal="1" simplifyMaxScale="1">
  <flags>
  ...
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" attr="KOD10K" type="categorizedSymbol">
    <categories>
      <category symbol="0" label="ciek wodny" value="0010_606" render="true"/>
    </categories>
    <symbols>
  ...
  <SingleCategoryDiagramRenderer diagramType="Pie" attributeLegend="1">
    <DiagramCategory spacingUnit="MM" rotationOffset="270" height="15" backgroundColor="#ffffff" scaleBasedVisibility="0" lineSizeType="MM" scaleDependency="Area" opacity="1" showAxis="0" enabled="0" spacingUnitScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" backgroundAlpha="255" penColor="#000000" spacing="0" diagramOrientation="Up" barWidth="5" maxScaleDenominator="1e+08" width="15" penAlpha="255" sizeScale="3x:0,0,0,0,0,0" minScaleDenominator="1" minimumSize="0" penWidth="0" direction="1" sizeType="MM" lineSizeScale="3x:0,0,0,0,0,0">
  ...
  <DiagramLayerSettings obstacle="0" priority="0" zIndex="0" placement="2" showAll="1" linePlacementFlags="2" dist="0">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="PL.PZGiK.333.0803__OT_Ciek_nazwa">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="idMPHP" index="24" name=""/>
    <alias field="polozenie" index="25" name=""/>
    <alias field="szerokosc" index="26" name=""/>
    <alias field="szerokosc_uom" index="27" name=""/>
    <alias field="okresowosc" index="28" name=""/>
    <alias field="przebieg" index="29" name=""/>
    <alias field="statusEksploatacji" index="30" name=""/>
    <alias field="x_informDodatkowa" index="31" name=""/>
    <alias field="ciek1" index="32" name=""/>
    <alias field="PL.PZGiK.333.0803__OT_Ciek_nazwa" index="33" name=""/>
    <alias field="KOD10K" index="34" name=""/>
    <alias field="ciek1_tmp" index="35" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="okresowosc" expression=""/>
    <default applyOnUpdate="0" field="przebieg" expression=""/>
    <default applyOnUpdate="0" field="statusEksploatacji" expression=""/>
    <default applyOnUpdate="0" field="x_informDodatkowa" expression=""/>
    <default applyOnUpdate="0" field="ciek1" expression=""/>
    <default applyOnUpdate="0" field="PL.PZGiK.333.0803__OT_Ciek_nazwa" expression=""/>
    <default applyOnUpdate="0" field="KOD10K" expression=""/>
    <default applyOnUpdate="0" field="ciek1_tmp" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" field="PL.PZGiK.333.0803__OT_Ciek_nazwa" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="KOD10K" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="ciek1_tmp" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="PL.PZGiK.333.0803__OT_Ciek_nazwa" desc=""/>
  ...
  <expressionfields>
    ...
    <field length="0" subType="0" precision="0" comment="" name="ciek1_tmp" type="10" typeName="string" expression="regexp_substr(ciek1,'#(.*)')"/>
  </expressionfields>
  <attributeactions>
    <defaultAction value="{00000000-0000-0000-0000-000000000000}" key="Canvas"/>
  </attributeactions>
  <attributetableconfig sortOrder="0" sortExpression="&quot;ciek1&quot;" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" name="idMPHP" type="field" hidden="0"/>
      <column width="-1" name="polozenie" type="field" hidden="0"/>
      <column width="-1" name="szerokosc" type="field" hidden="0"/>
      <column width="-1" name="szerokosc_uom" type="field" hidden="0"/>
      <column width="-1" name="okresowosc" type="field" hidden="0"/>
      <column width="-1" name="przebieg" type="field" hidden="0"/>
      <column width="-1" name="statusEksploatacji" type="field" hidden="0"/>
      <column width="-1" name="x_informDodatkowa" type="field" hidden="0"/>
      <column width="-1" name="ciek1" type="field" hidden="1"/>
      <column width="-1" name="KOD10K" type="field" hidden="0"/>
      <column width="-1" name="koniecWersjiObiektu" type="field" hidden="0"/>
      <column width="-1" name="PL.PZGiK.333.0803__OT_Ciek_nazwa" type="field" hidden="0"/>
      <column width="-1" name="ciek1_tmp" type="field" hidden="1"/>
    </columns>

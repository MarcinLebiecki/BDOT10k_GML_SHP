...
<qgis maxScale="1000" simplifyAlgorithm="0" labelsEnabled="0" readOnly="1" hasScaleBasedVisibilityFlag="1" simplifyMaxScale="1" simplifyLocal="1" minScale="10001" version="3.12.1-București" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyDrawingHints="0">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" symbollevels="0">
    <rules key="{d7c20f89-2746-42ae-a1d5-83103296b3e5}">
      <rule symbol="0" key="{0aee5768-9937-411c-a919-7d7efea0e684}" label="zbiornik materiałów pędnych lub gazu (symbol)" filter="KOD10K = '0010_414_2'"/>
      <rule symbol="1" key="{99856656-f342-4ff7-a962-f126ad19b820}" label="zbiornik materiałów sypkich (symbol)" filter="KOD10K = '0010_415_2'"/>
      <rule symbol="2" key="{b201f93f-0982-44aa-ae30-68a09e5e7be4}" label="osadnik lub zbiornik na ciecz (symbol)" filter="KOD10K = '0010_431_2'"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="0" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          ...
          <prop k="name" v="KARTO10k/0010_414_2.svg"/>
          <prop k="offset" v="0,0"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="1" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_415_2.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="2" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_431_2.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
  ...
  <labeling type="rule-based">
    <rules key="{04de5389-b3c5-4074-bd34-ed15888283ee}"/>
  </labeling>
  <customproperties>
  ...
  <aliases>
    ...
    <alias field="x_uwagi" index="29" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="gromadzonaSubstancja" expression=""/>
    <default applyOnUpdate="0" field="rodzajKonstrukcji" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="gromadzonaSubstancja" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" field="rodzajKonstrukcji" constraints="0" notnull_strength="0" unique_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="gromadzonaSubstancja"/>
    <constraint exp="" desc="" field="rodzajKonstrukcji"/>

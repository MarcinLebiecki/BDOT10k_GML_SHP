...
<qgis maxScale="1000" simplifyAlgorithm="0" labelsEnabled="0" readOnly="1" hasScaleBasedVisibilityFlag="1" simplifyMaxScale="1" simplifyLocal="1" minScale="10001" version="3.12.1-București" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyDrawingHints="0">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" symbollevels="0">
    <rules key="{de0b33d3-0342-419f-987c-33480aa8c4c7}">
      <rule symbol="0" key="{d50ad69d-df0a-410b-9167-8f40c1abee2a}" label="figura, kapliczka lub krzyż przydrożny" filter="KOD10K = '0010_330'"/>
      <rule symbol="1" key="{a11dd2e2-6a1f-4f27-a01a-a324ef37ed5e}" label="pomnik" filter="KOD10K = '0010_331'"/>
      <rule symbol="2" key="{b9a80346-b54a-456d-ab4e-9044cee2c0e6}" label="odosobniona mogiła" filter="KOD10K = '0010_332'"/>
      <rule symbol="3" key="{0f90d9dc-2309-4893-b670-79d9c4f8f517}" label="bunkier lub schron" filter="KOD10K = '0010_333'"/>
      <rule symbol="4" key="{2796d237-fd75-43cd-934d-304a6dac3858}" label="wieża" filter="KOD10K = '0010_334'"/>
      <rule symbol="5" key="{51d6cb09-b5bc-4bd8-861e-457136e550e6}" label="studnia głębinowa" filter="KOD10K = '0010_613'"/>
      <rule symbol="6" key="{c88c2ed0-86dd-4f49-ab03-f6617f177b85}" label="punkt wysokości poziomu wody" filter="KOD10K = '0010_632'"/>
      <rule symbol="7" key="{62ccf063-bbdc-47fe-ba8d-bc430428bd5f}" label="wiatrak" filter="KOD10K = '0010_335'"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="0" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          ...
          <prop k="name" v="KARTO10k/0010_330.svg"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="1" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_331.svg"/>
          <prop k="offset" v="0,-10"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="2" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_332.svg"/>
          <prop k="offset" v="0,-10"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="3" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_333.svg"/>
          <prop k="offset" v="0,-5"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="5" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_613.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="6" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_632.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="marker" name="7" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SvgMarker">
          ...
          <prop k="fixedAspectRatio" v="0"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="KARTO10k/0010_335.svg"/>
          <prop k="offset" v="0,-10"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>

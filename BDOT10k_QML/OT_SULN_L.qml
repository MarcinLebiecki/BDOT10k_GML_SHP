...
<qgis simplifyAlgorithm="0" styleCategories="AllStyleCategories" maxScale="1000" minScale="10001" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" readOnly="1" version="3.12.1-București" labelsEnabled="0" simplifyDrawingTol="1" simplifyDrawingHints="1" simplifyLocal="1">
  ...
  <renderer-v2 type="categorizedSymbol" symbollevels="0" attr="KOD10K" enableorderby="0" forceraster="0">
    <categories>
      <category value="0010_444" symbol="0" render="true" label="linia elektroenergetyczna najwyższego, wysokiego lub średniego napięcia"/>
      <category value="0010_446" symbol="1" render="true" label="linia elektroenergetyczna najwyższego, wysokiego lub średniego napięcia na słupach energetycznych"/>
      <category value="0010_449" symbol="2" render="true" label="linia telefoniczna"/>
    </categories>
    <symbols>
      <symbol type="line" alpha="1" name="0" force_rhr="0" clip_to_extent="1">
        ...
        <layer class="MarkerLine" enabled="1" locked="0" pass="0">
          ...
          <symbol type="marker" alpha="1" name="@0@1" force_rhr="0" clip_to_extent="1">
            <layer class="SvgMarker" enabled="1" locked="0" pass="0">
              ...
              <prop k="name" v="KARTO10k/0010_444_lewy.svg"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
        ...
        <layer class="MarkerLine" enabled="1" locked="0" pass="0">
          ...
          <prop k="interval_unit" v="MapUnit"/>
          <prop k="offset" v="0"/>
          <prop k="offset_along_line" v="200"/>
          <prop k="offset_along_line_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_along_line_unit" v="MapUnit"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          ...
          <symbol type="marker" alpha="1" name="@0@2" force_rhr="0" clip_to_extent="1">
            <layer class="SvgMarker" enabled="1" locked="0" pass="0">
              ...
              <prop k="fixedAspectRatio" v="0"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="KARTO10k/0010_444_prawy.svg"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="255,255,255,255"/>
      ...
      <symbol type="line" alpha="1" name="1" force_rhr="0" clip_to_extent="0">
        <layer class="SimpleLine" enabled="1" locked="0" pass="0">
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
                ...
                <Option type="Map">
                  ...
                  <Option type="Map" name="properties">
                    <Option type="Map" name="char">
                      ...
                      <Option type="QString" value="czyJestStrzalka_lewa(   @geometry_point_num -1)" name="expression"/>
                      <Option type="int" value="3" name="type"/>
                    </Option>
                    <Option type="Map" name="offset">
                      <Option type="bool" value="true" name="active"/>
                      <Option type="QString" value="obroc_strzalke_lewa(  @geometry_point_num -1)" name="expression"/>
                      <Option type="int" value="3" name="type"/>
                    </Option>
              ...
              <data_defined_properties>
                <Option type="Map">
                  ...
                  <Option type="Map" name="properties">
                    ...
                    <Option type="Map" name="char">
                      <Option type="bool" value="true" name="active"/>
                      <Option type="QString" value="czyJestStrzalka_prawa( @geometry_point_num -1)" name="expression"/>
                      <Option type="int" value="3" name="type"/>
                    </Option>
                    <Option type="Map" name="offset">
                      <Option type="bool" value="true" name="active"/>
                      <Option type="QString" value="obroc_strzalke_prawa(  @geometry_point_num-1)" name="expression"/>
                      <Option type="int" value="3" name="type"/>
                    </Option>
                    <Option type="Map" name="size">
                      <Option type="bool" value="true" name="active"/>
        ...
        <layer class="MarkerLine" enabled="1" locked="0" pass="0">
          ...
          <symbol type="marker" alpha="1" name="@1@3" force_rhr="0" clip_to_extent="1">
            <layer class="SvgMarker" enabled="1" locked="0" pass="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="0,0,0,255"/>
              <prop k="fixedAspectRatio" v="0"/>
              <prop k="horizontal_anchor_point" v="1"/>
              <prop k="name" v="KARTO10k/0010_428.svg"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MapUnit"/>
              <prop k="outline_color" v="255,255,255,255"/>
              ...
              <data_defined_properties>
                <Option type="Map">
                  ...
                  <Option type="Map" name="properties">
                    <Option type="Map" name="size">
                      <Option type="bool" value="true" name="active"/>
                      <Option type="QString" value="if(@geometry_point_num=1,0,5.4)" name="expression"/>
                      <Option type="int" value="3" name="type"/>
                    </Option>
                  </Option>
                  <Option type="QString" value="collection" name="type"/>
    ...
    <source-symbol>
      <symbol type="line" alpha="1" name="0" force_rhr="0" clip_to_extent="1">
        <layer class="SimpleLine" enabled="1" locked="0" pass="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="66,208,22,255"/>
          <prop k="line_style" v="solid"/>

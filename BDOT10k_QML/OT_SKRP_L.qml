...
<qgis maxScale="1000" simplifyAlgorithm="0" labelsEnabled="0" readOnly="1" hasScaleBasedVisibilityFlag="1" simplifyMaxScale="1" simplifyLocal="1" minScale="10001" version="3.12.1-București" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyDrawingHints="1">
  ...
  <renderer-v2 attr="KOD10K" enableorderby="0" forceraster="0" type="categorizedSymbol" symbollevels="0">
    <categories>
      <category symbol="0" value="0010_128_1" label="alejka lub pasaż (w skali)" render="true"/>
      <category symbol="1" value="0010_128_2" label="alejka lub pasaż (symbol)" render="true"/>
      <category symbol="2" value="0010_129" label="ścieżka" render="true"/>
      <category symbol="3" value="0010_135" label="schody" render="true"/>
    </categories>
    <symbols>
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="outlineWidth">
                  ...
                  <Option value="&quot;szerokosc&quot;*0.8 +2" type="QString" name="expression"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="outlineWidth">
                  <Option value="true" type="bool" name="active"/>
                  <Option value="&quot;szerokosc&quot;*0.8" type="QString" name="expression"/>
                  <Option value="3" type="int" name="type"/>
                </Option>
              </Option>
              <Option value="collection" type="QString" name="type"/>
    ...
    <source-symbol>
      <symbol clip_to_extent="1" force_rhr="0" type="line" name="0" alpha="1">
        <layer locked="0" enabled="1" pass="0" class="SimpleLine">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="36,50,201,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.26"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="klasaCiaguRuchuPieszego" expression=""/>
    <default applyOnUpdate="0" field="polozenie" expression=""/>
    <default applyOnUpdate="0" field="ruchRowerowy" expression=""/>
    <default applyOnUpdate="0" field="schody" expression=""/>
    ...
    <default applyOnUpdate="0" field="ulica2" expression=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="klasaCiaguRuchuPieszego" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" field="polozenie" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" field="ruchRowerowy" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" field="schody" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" field="szerokosc" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" field="materialNawierzchni" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" field="szerokosc_uom" constraints="0" notnull_strength="0" unique_strength="0"/>
    <constraint exp_strength="0" field="ulica2" constraints="0" notnull_strength="0" unique_strength="0"/>

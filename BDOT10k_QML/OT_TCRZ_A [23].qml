...
<qgis simplifyLocal="1" simplifyMaxScale="1" simplifyDrawingTol="1" styleCategories="Symbology|Labeling|Fields|Rendering" hasScaleBasedVisibilityFlag="1" labelsEnabled="0" symbologyReferenceScale="-1" minScale="250001" simplifyDrawingHints="1" maxScale="0" simplifyAlgorithm="0" version="3.22.11-Białowieża">
  <renderer-v2 attr="KOD10K" symbollevels="0" referencescale="-1" forceraster="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category value="0010_508_1" symbol="0" label="granica rezerwatu przyrody  - 0010_508_1 [23]" render="true"/>
    </categories>
    <symbols>
          ...
          <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="@0@1" type="marker">
            ...
            <layer enabled="1" class="SimpleMarker" pass="0" locked="0">
              <Option type="Map">
                ...
                <Option value="0,3.5" name="offset" type="QString"/>
                <Option value="3x:0,0,0,0,0,0" name="offset_map_unit_scale" type="QString"/>
                <Option value="MapUnit" name="offset_unit" type="QString"/>
  ...
  <aliases>
    ...
    <alias index="7" field="informacjaDodatkowa" name=""/>
    <alias index="8" field="kodKarto10k" name=""/>
    <alias index="9" field="numerCRFOP" name=""/>
    <alias index="10" field="nazwa" name=""/>
    <alias index="11" field="KOD10K" name=""/>
  </aliases>
  <defaults>

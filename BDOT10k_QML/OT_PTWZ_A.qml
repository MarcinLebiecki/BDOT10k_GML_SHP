...
<qgis maxScale="1000" simplifyAlgorithm="0" labelsEnabled="0" readOnly="1" hasScaleBasedVisibilityFlag="1" simplifyMaxScale="1" simplifyLocal="1" minScale="10001" version="3.12.1-București" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyDrawingHints="1">
  ...
  <renderer-v2 attr="KOD10K" enableorderby="0" forceraster="0" type="categorizedSymbol" symbollevels="0">
    <categories>
      <category symbol="0" value="0010_430" label="składowisko odpadów" render="true"/>
      <category symbol="1" value="0010_736" label="grunt nieużytkowany lub teren zdegradowany" render="true"/>
      <category symbol="2" value="0010_737" label="teren piaszczysty lub żwirowy" render="true"/>
      <category symbol="3" value="0010_738" label="teren kamienisty lub rumowisko skalne" render="true"/>
    </categories>
    <symbols>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="surowiec"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="surowiec"/>

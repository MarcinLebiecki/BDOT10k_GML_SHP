...
<qgis maxScale="1000" simplifyAlgorithm="0" labelsEnabled="0" readOnly="1" hasScaleBasedVisibilityFlag="1" simplifyMaxScale="1" simplifyLocal="1" minScale="10001" version="3.12.1-București" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyDrawingHints="1">
  ...
  <renderer-v2 attr="KOD10K" enableorderby="0" forceraster="0" type="categorizedSymbol" symbollevels="0">
    <categories>
      <category symbol="0" value="0010_349" label="ściana oporowa" render="true"/>
      <category symbol="1" value="0010_626" label="brzeg umocniony" render="true"/>
      <category symbol="2" value="0010_627" label="ostroga brzegowa" render="true"/>
      <category symbol="3" value="0010_628" label="falochron" render="true"/>
    </categories>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="material" index="26" name=""/>
    <alias field="wysokosc" index="27" name=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="material" constraints="0" notnull_strength="0" unique_strength="0"/>
